...
| useShaVersion       | boolean? | Use the short Git commit SHA as the version (default: false)       | When enabled, a commit SHA such as `fc36df512345` is uploaded as version `fc36df5` instead of using the version from `fxmanifest.lua`.                                               |
